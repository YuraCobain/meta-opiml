...
EXTERNALSRC_pn-${PN} = "/home/yurii/dev/projects/WebRTC4OrangePI/src"
EXTERNALSRC_BUILD_pn-${PN} = "/home/yurii/dev/projects/WebRTC4OrangePI/src/yocto_build"
...
do_compile( ) {
    ...
    cd ..
    export export PATH=$PWD/depot_tools:$PATH 
    cd -
